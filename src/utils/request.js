...
/**
 *
 * @function: package the Get method
 * @param url
 * @param params
 * @return {Promise}
 *
...
export function post(url, data={}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    axios.post(url, __formData).then(response => {
